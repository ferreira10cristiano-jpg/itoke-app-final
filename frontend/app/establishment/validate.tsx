...
const styles = StyleSheet.create({
  ...
  header: { flexDirection: 'row', alignItems: 'center', paddingHorizontal: 20, paddingVertical: 16, borderBottomWidth: 1, borderBottomColor: '#132A43' },
  backButton: { marginRight: 16 },
  title: { fontSize: 20, fontWeight: '700', color: '#FFFFFF' },
  content: { flex: 1 },
  contentContainer: { padding: 20, paddingBottom: 40 },

  modeSelector: { flexDirection: 'row', backgroundColor: '#132A43', borderRadius: 12, padding: 4, marginBottom: 16 },
  ...
  inputIcon: { width: 80, height: 80, borderRadius: 40, backgroundColor: '#132A43', justifyContent: 'center', alignItems: 'center', marginBottom: 20 },
  ...
  input: { backgroundColor: '#132A43', borderRadius: 12, paddingHorizontal: 20, paddingVertical: 16, fontSize: 18, color: '#FFFFFF', width: '100%', textAlign: 'center', borderWidth: 1, borderColor: '#1E3A5F', letterSpacing: 2 },
  ...
  previewCard: { backgroundColor: '#132A43', borderRadius: 16, padding: 18, width: '100%', borderWidth: 1, borderColor: '#1E3A5F' },
  ...
  divider: { height: 1, backgroundColor: '#1E3A5F', marginVertical: 14 },
  ...
  confirmedCard: { backgroundColor: '#132A43', borderRadius: 16, padding: 18, width: '100%', borderWidth: 1, borderColor: '#1E3A5F' },
  ...
  totalRow: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginTop: 14, paddingTop: 14, borderTopWidth: 1, borderTopColor: '#1E3A5F' },
