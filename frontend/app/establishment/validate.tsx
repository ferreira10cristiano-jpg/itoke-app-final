...
const styles = StyleSheet.create({
  ...
  header: { flexDirection: 'row', alignItems: 'center', paddingHorizontal: 20, paddingVertical: 16, borderBottomWidth: 1, borderBottomColor: '#22476B' },
  backButton: { marginRight: 16 },
  title: { fontSize: 20, fontWeight: '700', color: '#FFFFFF' },
  content: { flex: 1 },
  contentContainer: { padding: 20, paddingBottom: 40 },

  modeSelector: { flexDirection: 'row', backgroundColor: '#22476B', borderRadius: 12, padding: 4, marginBottom: 16 },
  ...
  inputIcon: { width: 80, height: 80, borderRadius: 40, backgroundColor: '#22476B', justifyContent: 'center', alignItems: 'center', marginBottom: 20 },
  ...
  input: { backgroundColor: '#22476B', borderRadius: 12, paddingHorizontal: 20, paddingVertical: 16, fontSize: 18, color: '#FFFFFF', width: '100%', textAlign: 'center', borderWidth: 1, borderColor: '#2E5A8F', letterSpacing: 2 },
  ...
  previewCard: { backgroundColor: '#22476B', borderRadius: 16, padding: 18, width: '100%', borderWidth: 1, borderColor: '#2E5A8F' },
  ...
  divider: { height: 1, backgroundColor: '#2E5A8F', marginVertical: 14 },

  creditsPreviewRow: { flexDirection: 'row', alignItems: 'center', backgroundColor: '#2E5A8F', padding: 12, borderRadius: 10, marginTop: 8 },
  ...
  confirmedCard: { backgroundColor: '#22476B', borderRadius: 16, padding: 18, width: '100%', borderWidth: 1, borderColor: '#2E5A8F' },
  ...
  totalRow: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginTop: 14, paddingTop: 14, borderTopWidth: 1, borderTopColor: '#2E5A8F' },
