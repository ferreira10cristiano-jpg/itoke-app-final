...
const s = StyleSheet.create({
  ...
  input: { backgroundColor: '#22476B', color: '#FFF', borderWidth: 1, borderColor: '#2E5A8F', borderRadius: 10, paddingHorizontal: 14, paddingVertical: 12, fontSize: 14 },
  ...
  catChip: { flexDirection: 'row', alignItems: 'center', gap: 6, backgroundColor: '#22476B', paddingHorizontal: 12, paddingVertical: 10, borderRadius: 10, borderWidth: 1, borderColor: '#2E5A8F' },
  ...
  saveBtnText: { fontSize: 16, fontWeight: '700', color: '#1B3A5C' },
});
