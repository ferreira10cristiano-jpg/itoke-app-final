  ...
  const renderQRTab = () => {
    ...
    return (
      <View>
        ...
        {sales.length === 0 ? (
          <View style={s.emptyState}>
            <Ionicons name="qr-code-outline" size={40} color="#334155" />
...
const s = StyleSheet.create({
  ...
  tab: { flexDirection: 'row', alignItems: 'center', gap: 6, paddingHorizontal: 14, paddingVertical: 8, borderRadius: 20, backgroundColor: '#1E293B' },
  ...
  totalCardSub: { flex: 1, backgroundColor: '#0F172A', borderRadius: 10, padding: 12 },
  ...
  rankBadge: { width: 32, height: 32, borderRadius: 16, backgroundColor: '#334155', justifyContent: 'center', alignItems: 'center' },
  ...
  barBg: { height: 6, backgroundColor: '#0F172A', borderRadius: 3, marginTop: 6 },
