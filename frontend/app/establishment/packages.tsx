...
const s = StyleSheet.create({
  ...
  balanceCard: { marginHorizontal: 20, backgroundColor: '#1E293B', borderRadius: 16, padding: 20, borderWidth: 1, borderColor: '#F59E0B33' },
  ...
  balanceStats: { flexDirection: 'row', backgroundColor: '#0F172A', borderRadius: 10, padding: 12 },
  balanceStat: { flex: 1, alignItems: 'center' },
  balanceStatValue: { fontSize: 18, fontWeight: '700', color: '#FFF' },
  balanceStatLabel: { fontSize: 11, color: '#64748B', marginTop: 2 },
  balanceStatDivider: { width: 1, backgroundColor: '#334155', marginHorizontal: 8 },
  ...
  packageCard: { flex: 1, backgroundColor: '#1E293B', borderRadius: 14, padding: 16, alignItems: 'center', borderWidth: 1, borderColor: '#334155' },
  ...
  packageDivider: { width: '80%', height: 1, backgroundColor: '#334155', marginVertical: 10 },
  ...
  buyBtnText: { fontSize: 13, fontWeight: '700', color: '#0F172A' },

  customSection: { paddingHorizontal: 20 },
  customDesc: { fontSize: 12, color: '#64748B', marginBottom: 10, paddingHorizontal: 20 },
  customRow: { flexDirection: 'row', gap: 10 },
  customInput: { flex: 1, backgroundColor: '#1E293B', borderRadius: 10, paddingHorizontal: 14, paddingVertical: 12, fontSize: 16, color: '#FFF', borderWidth: 1, borderColor: '#334155' },
  ...
  customBtnDisabled: { backgroundColor: '#334155', opacity: 0.6 },
  customBtnText: { fontSize: 13, fontWeight: '700', color: '#0F172A' },

  historySection: { paddingHorizontal: 0, marginTop: 8 },
  historyItem: { flexDirection: 'row', alignItems: 'center', backgroundColor: '#1E293B', padding: 14, marginHorizontal: 20, borderRadius: 10, marginBottom: 8, borderWidth: 1, borderColor: '#334155' },
  ...
  emptyState: { alignItems: 'center', paddingVertical: 32, backgroundColor: '#1E293B', marginHorizontal: 20, borderRadius: 14, borderWidth: 1, borderColor: '#334155' },
